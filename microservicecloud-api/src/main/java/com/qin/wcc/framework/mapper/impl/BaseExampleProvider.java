package com.qin.wcc.framework.mapper.impl;
...
@Slf4j
public class BaseExampleProvider extends MapperTemplate {

    public BaseExampleProvider(Class<?> mapperClass, MapperHelper mapperHelper) {
